...
digest pinned in `ecosystem-explorer/public/data-manifest.json`. Two builds of the same registry
state produce identical archive bytes, which is what lets the workflow skip republishing unchanged
data.
